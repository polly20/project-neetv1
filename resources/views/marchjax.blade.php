...
<!-- <br /> -->
Answer: <br />
<textarea class="form-control" id="answer"  rows="10" cols="100"></textarea>

<br /><br /><br />
Preview (auto load): <br />
<iframe id = "mcq1_div_autoload_container">
</iframe>
<br /><br /><br />
...
//            console.log($(this).val());
            Cookies.set('mcq1', $(this).val());

            var url = '/marchjax_preview';

            console.log("From cookies: " + Cookies.get('mcq1'));

//            $('#mcq1_div_autoload').empty().append(Cookies.get('mcq1'));

            $( "#mcq1_div_autoload_container" ).attr("src", url);

            //$("#answer_preview").attr("src", url);
