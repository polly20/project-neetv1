...
<link rel="stylesheet" href="{{ asset('css/fullcalendar.min.css', $ssl) }}">
@endsection
...
<script src="{{ asset('js/salvattore.min.js', $ssl) }}"></script>
<script src="{{ asset('js/jquery.flot.js', $ssl) }}"></script>
<script src="{{ asset('js/jquery.flot.resize.js', $ssl) }}"></script>
<script src="{{ asset('js/curvedLines.js', $ssl) }}"></script>
<script src="{{ asset('js/jquery.vmap.min.js', $ssl) }}"></script>
<script src="{{ asset('js/jquery.vmap.world.js', $ssl) }}"></script>
<script src="{{ asset('js/jquery.easypiechart.min.js', $ssl) }}"></script>
<script src="{{ asset('js/jquery.peity.min.js', $ssl) }}"></script>
<script src="{{ asset('js/moment.min.js', $ssl) }}"></script>
<script src="{{ asset('js/fullcalendar.min.js', $ssl) }}"></script>

<!-- Charts and maps-->
<script src="{{ asset('demo/js/flot-charts/curved-line.js', $ssl) }}"></script>
<script src="{{ asset('demo/js/flot-charts/line.js', $ssl) }}"></script>
<script src="{{ asset('demo/js/flot-charts/dynamic.js', $ssl) }}"></script>
<script src="{{ asset('demo/js/flot-charts/chart-tooltips.js', $ssl) }}"></script>
<script src="{{ asset('demo/js/other-charts.js', $ssl) }}"></script>
<script src="{{ asset('demo/js/jqvmap.js', $ssl) }}"></script>
@endsection
